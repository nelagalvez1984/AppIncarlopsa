...
public class DAOUsuario extends DAOBase implements IDAO {
    ...
    private String consultaLecturaDameTodos = "SELECT idusuario, nombre, apellidos, dni, tipoempleado, foto, username "
            + "FROM usuario";
    private String consultaLecturaPorId = "SELECT idusuario, nombre, apellidos, dni, tipoempleado, foto, username "
            + "FROM usuario WHERE idusuario = ?";
    private String consultaLecturaPorTipoEmpleado = "SELECT idusuario, nombre, apellidos, dni, tipoempleado, foto, username "
    ...
    private String consultaUpdate = "UPDATE usuario SET nombre = ?, apellidos = ?, dni = ?, "
            + "tipoempleado = ?, foto = ?, username = ? WHERE idusuario = ?";

    // CAMBIOS = HE METIDO EL CAMPO USERNAME DENTRO DE LA TABLA USUARIO Y HE METIDO EN EL METODO ELEMENTOACREAR EL USERNAME
